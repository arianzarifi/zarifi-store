...
<div class = "product-tabs">
  ...
  <div class = "tab-content">
    ...
    <div class="tab-panel" id="specs">
      <ul class = "specs-list">
        <h4>مشخصات کلی</h4>
        <li><span class = "label">نوع جارو برقی</span><span class = "value">کیسه دار</span></li>
        <li><span class = "label">تعداد سری</span><span class = "value">سه عدد</span></li>
        <li> <span class = "label">طول کابل برق</span> <span class ="value">8 متر</span></li>
        <li> <span class = "label">میزان صدا</span> <span class = "value">70 دسی بل</span></li>
      </ul>
    </div>
    <div class="tab-panel" id="reviews">
      <div class="comments-sendbtn">
        <div class="sendbtn">
          <h5>نظر خود خود را در مورد کالا ثبت کنید</h5>
          <button class = "add-comment-btn">ثبت نظر</button>
        </div>
        <div class = "comments">
          <h3>نظرات کاربران</h3>
          <div class = "comment">
             <div class = "author">علی</div>
             <div class = "text">این محصول عالی بود</div>
          </div>
          <div class = "comment">
             <div class = "author">سمیرا</div>
             <div class = "text">کیفیت نسبت به قیمتش خوبه.</div>
          </div>
        </div>
      </div>
