      ...
      <div class="footer-page">
        ...
        <div class="pages-site">
          <div class="website-page">
            ...
            <div class="page-link">
              <a href="#" class="abutus-link linkfooter">درباره ما</a>
              <a href="#" class="FAQ-link linkfooter">سوالات متداول</a>
              <a href="#" class="Terms-link linkfooter">شرایط و قوانین</a>
              <a href="#" class="PrivacyPolicy-link linkfooter">حریم خصوصی</a>
              <a href="#" class="Shipping-link linkfooter">ارسال و تحویل</a>
              <a href="#" class="OrderTracking-link linkfooter">پیگیری سفارش</a>
            </div>
          </div>
        </div>
       
        <div>
          <div class="Licenses-social">
            <h3 class="social-title">ما را در شبکه‌های اجتماعی دنبال کنید</h3>
            <div class="social-icons">
                <!-- <a href="#" class="social-icon facebook"></a> -->
                <a href="#" class="social-icon instagram"><img src="assets/icons/icon-instagram.png" alt="" class="insta-img"></a></a>
                <!-- <a href="#" class="social-icon twitter"><i class="fab fa-twitter"></i></a> -->
                <a href="#" class="social-icon telegram"><img src="assets/icons/icon-telegram.png" alt="" class="tel-img"></a>
            </div>
        
            <h3 class="license-title">نمادها و مجوزها</h3>
            <div class="licenses">
                <!-- این بخش بعداً از پنل ادمین با لوگوها پر میشه -->
                <img src="" alt="" class="license-img">
                <img src="" alt="" class="license-img">
            </div>
        </div>
