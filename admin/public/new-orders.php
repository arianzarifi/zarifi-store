...
<head>
    ...
    <title>سفارش‌های جدید | پنل ادمین</title>

    <link rel="stylesheet" href="assets/css/new-orders.css">
</head>
<body>
    <div class="layout">
                ...
                <div class="table-box">
                    <table>
                        ...
                        <tbody>
                            ...
                            <!-- سفارش‌های بیشتر اینجا اضافه میشن -->
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <script src="assets/js/pages/new-orders.js"></script>
</body>
</html>
